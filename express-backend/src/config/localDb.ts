...
const defaultDb: LocalDbSchema = {
  ...
  categories: [
    ...
    },
    {
      id: 'cat-4',
      name: 'Spices & Masala',
      image_url: 'https://monthly-grocery-media-prod.s3.ap-south-1.amazonaws.com/products/everest_garam_masala_100g.png',
    },
    {
      id: 'cat-5',
      name: 'Dry Fruits',
      image_url: 'https://monthly-grocery-media-prod.s3.ap-south-1.amazonaws.com/products/cadbury_bournvita_1kg.png',
    },
    {
      id: 'cat-6',
      name: 'Snacks',
      image_url: 'https://monthly-grocery-media-prod.s3.ap-south-1.amazonaws.com/products/maggi_masala_noodles_12pack.png',
    },
    {
      id: 'cat-7',
      name: 'Beverages',
      image_url: 'https://monthly-grocery-media-prod.s3.ap-south-1.amazonaws.com/products/tata_tea_gold_500g.png',
    },
    {
      id: 'cat-8',
      name: 'Biscuits',
    ...
    },
    {
      id: 'cat-9',
      name: 'Cleaning',
      image_url: 'https://monthly-grocery-media-prod.s3.ap-south-1.amazonaws.com/products/surf_excel_detergent_3kg.png',
    },
    {
      id: 'cat-10',
      name: 'Personal Care',
    ...
    },
    {
      id: 'cat-11',
      name: 'Home & Kitchen',
      image_url: 'https://monthly-grocery-media-prod.s3.ap-south-1.amazonaws.com/products/lizol_floor_cleaner_2l.png',
    },
    {
      id: 'cat-12',
      name: 'Baby Care',
